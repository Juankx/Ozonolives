        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <img 
                ...
                className="w-8 h-8"
              />
              <span className="text-xl font-bold">Ozonolive</span>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Especialistas en purificación de agua con tecnología de ozono y ósmosis inversa. 
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:info@ozonolive.com" className="text-gray-400 hover:text-blue-400 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <p>📧 ozonolive14@gmail.com</p>
              <p>📞 +593 02-2401386</p>
              <p>📱 +593 99 053 0192</p>
              <p>📱 +593 99 869 2215</p>
              <p>📍 De los Guayacanes N53-210 entre Los Pinos y Belladonas, atrás del Hospital de Solca, Quito-Ecuador</p>
              <p>🕒 Lunes a viernes 8:30 a 17:30 y Sábado 9:00 a 12:30</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {currentYear} Ozonolive. Todos los derechos reservados.
            </p>
